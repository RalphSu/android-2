...
/**
 * Retrieves and organizes media to play. Before being used, you must call {@link #prepare()}, which will retrieve all
 * of the music on the user's device (by performing a query on a content resolver). After that, it's ready to retrieve a
 * random song, with its title and URI, upon request.
 */
public class MusicRetriever {
	...
	/**
	 * Loads music data. This method may take long, so be sure to call it asynchronously without blocking the main
	 * thread.
	 */
	public void prepare() {
