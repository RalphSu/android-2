...
public class MusicList extends ListActivity implements MusicRetrieverPreparedListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.player_song_list);
	...
	public void onMusicRetrieverPrepared() {
		...
		mCursor = mRetriever.getCursor();

		ListAdapter adapter = new MusicListAdapter(this, android.R.layout.simple_expandable_list_item_2, mCursor,
				new String[] {}, new int[] {});
...
class MusicListAdapter extends SimpleCursorAdapter {
	...
	public MusicListAdapter(Context context, int layout, Cursor c, String[] from, int[] to) {
	...
	public void bindView(View view, Context context, Cursor cursor) {
		...
		artistView.setText(cursor.getString(cursor.getColumnIndexOrThrow(MediaStore.Audio.Media.DISPLAY_NAME)));

		// int duration = cursor.getInt(cursor.getColumnIndexOrThrow(MediaStore.Audio.Media.DURATION));
	}

	public static String makeTimeString2(long milliSecs) {
