...
/**
 * Main activity: shows media player buttons. This activity shows the media player buttons and lets the user click them.
 * No media handling is done here -- everything is done by passing Intents to our {@link MusicService}.
 * */
