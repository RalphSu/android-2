package org.app.qqmusic.service;

import java.io.IOException;
import java.text.SimpleDateFormat;
import java.util.Date;
import org.app.qqmusic.tool.DBHelper;
import org.app.qqmusicplayer.PlayMusicActivity;
...
public class MusicService extends Service implements
	...
	private void ShowNotifcation() {
		...
		notification.icon = R.drawable.icon;// 为通知栏增加图标
		...
		notification.setLatestEventInfo(getApplicationContext(), "播放中", _title,
				contentIntent);
