...
import com.mixmusic.view.Find_Newest_Activity;
...
public class CustomDialog extends Dialog {
	...
	public static class Builder {
		...
		public String getMessage() {
			this.message = editMsg.getText().toString().trim();
			editMsg.setSelection(editMsg.getText().length());// 设置光标
			return this.message;
		}
		...
		public CustomDialog create() {
			...
			editMsg = (EditText) layout.findViewById(R.id.message);
