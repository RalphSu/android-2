...
public class ChangedActivity  extends Activity {
   ...
   ImageView imageview_back;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.changed_main);
		
		context = ChangedActivity.this;
		...
		Intent i1 = new Intent(context, Changed_Hot_Activity.class);
		listViews.add(getView("A", i1));
		Intent i2 = new Intent(context, Changed_Newest_Activity.class);
