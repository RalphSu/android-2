...
public final class CameraUtil {
	...
	public static String resolvePhotoFromIntent(final Context ctx, final Intent data, final String dir) {
		...
		if (cu != null && cu.getCount() > 0) {
			...
			try {
				final String fileName = null;//MD5.getMessageDigest(DateFormat.format("yyyy-MM-dd-HH-mm-ss", System.currentTimeMillis()).toString().getBytes()) + Util.PHOTO_DEFAULT_EXT;
				filePath = dir + fileName;
